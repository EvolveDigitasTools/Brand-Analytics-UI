...
/* --- Neumorphic style for Group SKU Mapping --- */
.sku_mapp {
  display: flex;
...
.group-sku-mapping-card:hover {
  box-shadow: inset 5px 5px 10px #d1d9e6, inset -5px -5px 10px #ffffff;
}

/* Heading */
.group-sku-mapping-card h3 {
  font-weight: 600;
...
.group-sku-mapping-card .btn:hover {
  background: linear-gradient(145deg, #75BFB0, #75BFB0);
...
/* File input */
.group-sku-mapping-card input[type="file"] {
  margin: 10px 0 20px;
  border-radius: 8px;
  padding: 10px 12px;
  background: #f2f5f7;
...
/* .group-sku-mapping-card input[type="file"]:hover {
  box-shadow: inset 0px 0px 4px #75BFB0, inset 0px 0px 4px #75BFB0;
} */
