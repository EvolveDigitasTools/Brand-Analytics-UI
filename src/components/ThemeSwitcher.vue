<template>
  <div class="w-[30px] px-1 flex items-center mx-8">
    <svg v-if="isDark" @click="toggleDark()" class="w-full h-full" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg v-else @click="toggleDark()" class="w-full h-full" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
        <path class="fill-current text-slate-400"
